...
{
public:
	RequestTimeoutException(const std::string &msg = "Request Timeout")
	    : HttpException(408, msg, "Request Timeout") {}
};
...
{
public:
	GatewayTimeoutException(const std::string &msg = "Gateway Timeout")
	    : HttpException(504, msg, "Gateway Timeout") {}
};

#endif // HTTPEXCEPTIONS_HPP